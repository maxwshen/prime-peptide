...
# Default params
inp_dir = _config.OUT_PLACE + 'd_count/'
...
def main(argv):
  ...
  for nm in exp_design['Name']:
    ...
    print(nm)
    step = 100
    for start in range(0, 12000, step):
      print(start)
      end = start + step
      ...
      if data_mdf is None:
        ...
        data_mdf = data_mdf.append(data_df)
    ...
    data_mdf = data_mdf.fillna(value = 0)
    data_mdf['prime_edit'] = data_mdf['Prime edit']
